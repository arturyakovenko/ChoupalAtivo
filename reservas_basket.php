...
<head>
    ...
    <title>Reservar Basket - Choupal Ativo</title>
...
<body class="bg-gray-100 text-black">
    ...
    <div class="relative h-[40vh] bg-black flex items-center justify-center overflow-hidden">
        <img src="fts/index-basket.webp" class="absolute inset-0 w-full h-full object-cover opacity-50">
        <div class="relative z-10 text-center px-4">
            <h1 class="text-5xl md:text-7xl font-extrabold text-white mb-2">Reservar <span class="text-neon">Basket.</span></h1>
            <p class="text-gray-300 text-lg">Campo Principal - Piso Rápido</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="reservas_tenis.php" class="text-sm font-bold text-gray-500 hover:text-black underline">Queres Ténis?</a>
                </div>
                
                <form action="reservas_basket.php" method="GET" class="bg-white p-6 rounded-xl shadow-lg mb-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg">
                    <h3 class="font-bold mb-4 text-gray-500 uppercase text-sm">Disponibilidade Basket (<?php echo date('d/m/Y', strtotime($data_selecionada)); ?>)</h3>
            ...
            <div>
                ...
                <form action="actions/processar_basket.php" method="POST" class="bg-white p-8 rounded-xl shadow-2xl border-t-4 border-[#ADFF2F]">
                    ...
                    <div class="space-y-4">
                        <div class="p-4 bg-gray-50 rounded-lg border border-gray-200 mb-6">
                            <p class="text-sm text-gray-500">A reservar Basket para:</p>
